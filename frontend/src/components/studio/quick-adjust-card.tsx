import { NUMERIC_TYPES } from "@/lib/studio-constants";
...
export function QuickAdjustCard({ attr, index, onUpdate }: QuickAdjustProps) {
  ...
  return (
    <div className="space-y-3 rounded-lg border border-border bg-gradient-to-br from-card/80 to-transparent p-3 backdrop-blur-[2px] transition-all hover:border-primary/30">
