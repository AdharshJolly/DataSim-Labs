...
export const TYPE_OPTIONS = [
  {
    ...
    options: [
      {
        value: "integer" as DataType,
        label: "Integer",
        icon: Hash,
        description: "Whole numbers only",
      },
      {
        value: "float" as DataType,
        label: "Decimal",
        icon: Binary,
        description: "Numbers with decimal points",
      },
      {
        value: "boolean" as DataType,
        label: "True/False",
        icon: ToggleLeft,
        description: "Yes/No, 1/0, True/False",
      },
      {
        value: "categorical" as DataType,
        label: "Category",
        icon: ListFilter,
  ...
  },
  {
    ...
    options: [
      {
        value: "name" as DataType,
        label: "Full Name",
        icon: User,
        description: "Realistic first and last names",
      },
      {
        value: "email" as DataType,
        label: "Email",
        icon: Mail,
        description: "Randomized valid email addresses",
      },
      {
        value: "address" as DataType,
        label: "Address",
        icon: MapPin,
        description: "Street, city, and zip codes",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        label: "Date",
        icon: Calendar,
        description: "Calendar dates and timestamps",
      },
      {
        value: "text" as DataType,
        label: "Text",
        icon: Type,
        description: "Random words or sentences",
      },
    ],
  },
];
...
export const FORMAT_OPTIONS = [
  ...
  {
    value: "jsonl" as OutputFormat,
    label: "JSONL",
    ext: ".jsonl",
    icon: FileJson,
  },
  {
    value: "excel" as OutputFormat,
    label: "Excel",
    ext: ".xlsx",
