        ...
        templates = [
            {
                ...
                "columns": {
                    "order_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 8, "max_length": 12},
                    },
                    "user_age": {
                        "data_type": "integer",
                        "distribution": {
            ...
            },
            {
                ...
                "columns": {
                    "patient_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 6, "max_length": 8},
                    },
                    "age": {
                        "data_type": "integer",
                        "distribution": {
                    ...
                    "diagnosis": {
                        ...
                        "distribution": {
                            "type": "weighted_categorical",
                            "categories": ["Healthy", "Hypertension", "Diabetes"],
            ...
            },
            {
                ...
                "description": "Bank accounts, transactions, and fraud risk indicators.",
                "columns": {
                    "account_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 10, "max_length": 10},
                    },
                    "customer_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 6, "max_length": 8},
                    ...
                    "account_type": {
                        ...
                        "distribution": {
                            "type": "weighted_categorical",
                            "categories": ["Checking", "Savings", "Money Market", "CD"],
            ...
            {
                "id": "tpl-saas",
                "name": "SaaS Events & Users",
                "description": "User accounts, subscription events, and product usage metrics.",
                "columns": {
                    "user_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 8, "max_length": 12},
                    ...
                    "email": {
                        "data_type": "text",
                        "distribution": {"min_length": 10, "max_length": 50},
                    },
                    "company": {
                        "data_type": "text",
                        "distribution": {"min_length": 5, "max_length": 30},
                    },
                    "plan": {
                        "data_type": "categorical",
                        "distribution": {
            ...
            },
            {
                ...
                "description": "Users, posts, comments, and engagement metrics.",
                "columns": {
                    "user_id": {
                        "data_type": "text",
                        "distribution": {"min_length": 8, "max_length": 12},
                    ...
                    "username": {
                        "data_type": "text",
                        "distribution": {"min_length": 5, "max_length": 20},
                    },
                    "followers": {
                        "data_type": "integer",
                        "distribution": {
                    ...
                    "post_content": {
                        "data_type": "text",
                        "distribution": {"min_length": 10, "max_length": 280},
                    },
                    "likes": {
                        "data_type": "integer",
                        "distribution": {
